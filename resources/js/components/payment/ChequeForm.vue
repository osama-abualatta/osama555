<template>
    <div class="col-md-10 row">
        <b-form-group
                ...
                :label="$t('bank_name')"
                label-for="input-1">
            <b-form-input type="text" v-model="form.bank_name"
                          v-validate="{required: true}" name="username"
                          :class="{'form-control': true, 'is-invalid': errors.has('bank_name')}"
                          :placeholder="$t('bank_name')"></b-form-input>
            <div class="invalid-feedback" v-if="errors.has('bank_name')">
